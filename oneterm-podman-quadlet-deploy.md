...
Environment=TZ=<YOUR_TZ> MYSQL_ROOT_PASSWORD=<MYSQL_ROOT_PASSWORD> MYSQL_DATABASE=oneterm
...
Environment=TZ=<YOUR_TZ> SYSTEM_DEFAULT_LANGUAGE=en-US
...
Environment=TZ=<YOUR_TZ> ONETERM_API_HOST=127.0.0.1:8888 ACL_API_HOST=127.0.0.1:5000 NGINX_PORT=80
